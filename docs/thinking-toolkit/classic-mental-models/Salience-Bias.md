...
**Other Related Models:** While not as directly related, other models like the [Anchoring Bias](/docs/thinking-toolkit/classic-mental-models/anchoring-bias) (over-reliance on the first piece of information received) and the [Framing Effect](/docs/thinking-toolkit/classic-mental-models/framing-effects) (how information is presented influences decisions) also touch upon aspects of attention and information emphasis that are relevant to Salience Bias.
