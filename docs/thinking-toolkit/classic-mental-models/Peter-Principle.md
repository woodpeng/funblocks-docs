...
**1. Parkinson's Law:** [Parkinson's Law](/docs/thinking-toolkit/classic-mental-models/parkinsons-law) states that "work expands so as to fill the time available for its completion." While seemingly different, there's a subtle connection with the Peter Principle. Both models address inefficiencies within organizations, but from different angles. Parkinson's Law focuses on the *process* of work and how bureaucracy can inflate tasks, while the Peter Principle focuses on the *people* within the hierarchy and how promotions can lead to incompetence.
